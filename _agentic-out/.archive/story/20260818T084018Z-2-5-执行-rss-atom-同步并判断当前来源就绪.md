...
- 通过 rustfmt、workspace Clippy `-D warnings`、非桌面 Rust 127/127、xtask contracts、前端 format/lint/typecheck、Vitest 93/93、build；Playwright 26/27 全量后仅重跑失败定位器，最终 27 个场景均有绿色证据。
